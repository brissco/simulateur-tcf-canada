-- ============================================================
-- TCF Canada AI+ — Seed des 11 Combinaisons (schéma normalisé)
-- Copiez-collez ce code dans votre SQL Editor Supabase
-- ============================================================

-- Nettoyage
DELETE FROM public.documents;
DELETE FROM public.taches;
DELETE FROM public.sujets;

-- ============================================================
-- Combinaison 11
-- ============================================================
DO $$
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 11') RETURNING id INTO v_sujet_id;

  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 1, 'Tâche 1 — Message informel',
    'Vous allez fêter votre anniversaire. Vous envoyez un message à vos amis pour les inviter. Vous leur décrivez le programme de la soirée et leur demandez de l''aide pour l''organisation',
    'simple');

  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 2, 'Tâche 2 — Message semi-formel',
    'Vous avez participé à un concours de cuisine. Sur votre site Internet, vous écrivez un court article pour raconter cette journée. Vous expliquez pourquoi vous avez aimé ou pourquoi vous n''avez pas aimé cette expérience',
    'simple');

  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 3, 'Tâche 3 — Expression d''un point de vue',
    'Le travail des jeunes pendant les vacances',
    'documentaire') RETURNING id INTO v_tache_id;

  INSERT INTO public.documents (tache_id, titre_document, contenu) VALUES
  (v_tache_id, 'Document 1',
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 10') RETURNING id INTO v_sujet_id;
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 9') RETURNING id INTO v_sujet_id;

  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 1, 'Tâche 1 — Message informel',
    'Vous répondez à ce message sur le forum. Vous parlez de votre pays et de votre culture. Vous essayez de donner envie aux internautes de découvrir votre pays',
    'simple');

  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 2, 'Tâche 2 — Message semi-formel',
    'Vous avez commencé un nouveau travail. Vous écrivez un courriel à vos amis pour leur raconter comment s''est passée votre première semaine et ce que vous pensez de ce nouveau poste',
    'simple');
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 8') RETURNING id INTO v_sujet_id;
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 7') RETURNING id INTO v_sujet_id;
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 6') RETURNING id INTO v_sujet_id;
  ...
  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 2, 'Tâche 2 — Message semi-formel',
    '« Ecole De Musique ! Cours Gratuits, Concerts, Jeux. Rendez-Vous Vendredi, À partir de 9 Heures » Vous avez participé à cet évènement. Vous écrivez à vos amis pour raconter votre expérience et vous donnez votre opinion sur cette journée.',
    'simple');
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 5') RETURNING id INTO v_sujet_id;

  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 1, 'Tâche 1 — Message informel',
    '« Je cherche un vélo en bon état et bon marché. Contactez-moi par courriel : mathieu@gmail.com » Vous avez un vélo à vendre. Vous écrivez un courriel pour décrire votre vélo et proposer un prix. Vous lui donnez un RDV pour essayer le vélo.',
    'simple');
  ...
  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 3, 'Tâche 3 — Expression d''un point de vue',
    'La sévérité des parents envers les enfants',
    'documentaire') RETURNING id INTO v_tache_id;
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 4') RETURNING id INTO v_sujet_id;
  ...
  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 3, 'Tâche 3 — Expression d''un point de vue',
    'Limitation Des Voitures Dans Les Centres-Villes.',
    'documentaire') RETURNING id INTO v_tache_id;
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 3') RETURNING id INTO v_sujet_id;
  ...
  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 2, 'Tâche 2 — Message semi-formel',
    'Vous travaillez dans une association qui aident les personnes âgées. Rédigez un article de blog pour raconter vos expériences et convaincre d''autres personnes de rejoindre l''association.',
    'simple');
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 2') RETURNING id INTO v_sujet_id;
  ...
  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 3, 'Tâche 3 — Expression d''un point de vue',
    'Vie en colocation entre adultes.',
    'documentaire') RETURNING id INTO v_tache_id;
...
DECLARE v_sujet_id uuid; v_tache_id uuid;
BEGIN
  INSERT INTO public.sujets (titre_combinaison) VALUES ('Combinaison 1') RETURNING id INTO v_sujet_id;
  ...
  INSERT INTO public.taches (sujet_id, numero_tache, titre_tache, consigne, type_tache)
  VALUES (v_sujet_id, 3, 'Tâche 3 — Expression d''un point de vue',
    'Rôle De La Télévision Dans L''éducation Des Enfants.',
    'documentaire') RETURNING id INTO v_tache_id;
